    ...
    <div id='projects' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <div className='grid grid-cols-2 my-10 gap-5 '>
            ...
            {projectData.map((project, index) => (
                ...
                group grayscale-75 border-gray-200 hover:grayscale-0 transition duration-300 hover:shadow-black'
                style={{backgroundImage: `url(${project.bgImage})`}}>
                    <div className='h-52 md:h-80 bg-gray-400 w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5
                     flex items-center justify-between duration-500 group-hover:bottom-7 hover:bg-lightHover'></div>
                        <div>
